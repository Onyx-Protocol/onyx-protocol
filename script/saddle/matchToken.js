...
This checks to see if the deployed byte-code matches this version of the Onyx Protocol.
...
npx saddle -n rinkeby script token:match 0x19B674715cD20626415C738400FDd0d32D6809B6 '{
  ...
  "name": "Onyx Kyber Network Crystal",
  "symbol": "cKNC",
  "decimals": "8",
  "admin": "$Timelock"
}'
...
(async function() {
  ...
  console.log(`Matching oToken at ${address} with ${JSON.stringify(conf)}`);
  ...
  await saddle.match(address, 'OErc20Immutable', deployArgs);
