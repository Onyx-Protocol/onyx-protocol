...
export interface OTokenMethods {
...
export interface OTokenScenarioMethods extends OTokenMethods {
  setTotalBorrows(amount: encodedNumber): Sendable<void>;
  setTotalReserves(amount: encodedNumber): Sendable<void>;
}

export interface OToken extends Contract {
  methods: OTokenMethods;
  name: string;
}

export interface OTokenScenario extends Contract {
  methods: OTokenScenarioMethods;
  name: string;
}
