...
import "./OErc20Delegate.sol";

/**
 * @title Onyx's ODai Contract
 * @notice OToken which wraps Multi-Collateral DAI
 * @author Onyx
 */
contract ODaiDelegate is OErc20Delegate {
    /**
