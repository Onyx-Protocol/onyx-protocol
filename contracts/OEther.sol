...
/**
 * @title Onyx's OEther Contract
 * @notice OToken which wraps Ether
 * @author Onyx
 */
contract OEther is OToken {
    /**
     * @notice Construct a new OEther money market
    ...
    /**
     * @notice Send Ether to OEther to mint
     */
