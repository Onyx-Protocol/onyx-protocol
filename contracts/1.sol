...
contract OToken is OTokenInterface, Exponential, TokenErrorReporter {
    ...
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, OTokenInterface oTokenCollateral) internal returns (uint, uint) {
        ...
        if (oTokenCollateral.decimals() == 0) {
            /////////////////////////
            // EFFECTS & INTERACTIONS
            // (No safe failures beyond this point)
        ...
        (amountSeizeError, seizeTokens) = comptroller.liquidateCalculateSeizeTokens(address(this), address(oTokenCollateral), actualRepayAmount);
...
// File: contracts/EIP721Interface.sol
...
interface EIP721Interface /* is ERC165 */ {
...
// File: contracts/XCNInterface.sol
...
// File: contracts/Lens/OnyxLens.sol
    ...
    function oTokenMetadata(OToken oToken) public returns (OTokenMetadata memory) {
        ...
        return OTokenMetadata({
            ...
            underlyingDecimals: 
                ...
                ? 18 
                : (OErc20(address(oToken)).decimals() > 0 
